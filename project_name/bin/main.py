"""
`project-name` is the top-level command for accessing various subcommands.
...
def _try_import(module):
    ...
    return importlib.import_module(relative_module, 'project_name.bin')
...
def _build_commands():
    ...
    if unavailable:
        ...
        for module, ex in unavailable:
            DESCRIPTION += (
                f'\nWARNING: "project-name {module}" is unavailable due to:'
...
def main():
    ...
    top_parser.add_argument(
        ...
        help="Show the project-name version number and exit."
    )
